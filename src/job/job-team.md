...
- 邮箱：opensource-talents@bosc.ac.cn。

### <FontIcon icon="desktop" /> 共性要求
- 认可开源理念，参与过开源项目优先，参加过“一生一芯”优先。
- 有专长的同学，支持提议和开辟新项目，比如开个新IP等。
- 基础好，喜欢学习钻研。
- 北京（开芯院、计算所），深圳（鹏城），上海（处理器中心）。
- 一般要求1年以上；部分岗位支持线上实习（具体岗位具体看）。
- 本科（200-300元），硕士（300-400元），博士（300-500元）。
- 住宿补助每月1500元。

### <FontIcon icon="briefcase" /> 招聘类型
- 暑期夏令营
    - 本科、硕士。
    - 正在学习“一生一芯”。
    - 北京开芯院、上海处理器中心。
...
- 保研/考研
    ...
    - 另有数位老师委托推荐。
- 申博
    - 鹏城国家实验室（与国科大等11校招收联培博士）。

### <FontIcon icon="compass" /> 招聘方向
- 芯片方向
  - 项目：香山、“一生一芯”、开源IP。
...
### <FontIcon icon="rainbow" /> 招聘活动

::: tip 进行中：长期有效的招聘活动
- **招聘类型**
    - 2023/2024校招。
- **简历收集**
    - 简历命名为【学校-年级-姓名-意向方向】，发送到【opensource-talents@bosc.ac.cn】。
- **面试安排**
    - 接收到邮件后会及时安排面试。
:::
