...
::: tip 学习“一生一芯”前，你需要按照邮件指引，创建自己的专属学习记录，请务必查收此邮件！
创建完成后，可查看：[“一生一芯”学习情况记录表用户手册](https://fa45epzd9c7.feishu.cn/wiki/NXwQwuzxfiXH2Ukxe2wcgtAdnJ1?from=from_copylink)
:::
